...
```bash
# Environment variable
export AI_CODE_REVIEW_DIFF_DOWNLOAD_TIMEOUT=60  # 1 minute (default: 30)
```

```yaml
# In .ai-code-review.yaml
diff_download_timeout: 30  # seconds
```
...
**Default timeout (30 seconds) is sufficient for most cases.**
